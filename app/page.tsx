...
export default async function Page() {
  ...
  try {
    // Fetch hero post
    const heroRes = await fetch(`${backend_uri}/api/posts/featured-news/koshiinfo.com`, options)
    if (!heroRes.ok) {
    ...
    // Fetch category data 
    const res = await fetch(`${backend_uri}/api/posts/homepage/koshiinfo.com`, options)
